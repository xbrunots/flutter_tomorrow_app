...
class ForecastWeekRepositoryImplMock extends Mock implements ForecastWeekRepositoryImpl {}

void main() {
  final repository = ForecastWeekRepositoryImplMock();
  final useCase = ForecastWeekUseCaseImpl(repository);

  final String locationMock = 'Sorocaba';

  List<WeatherWeekEntity> listMock = [
